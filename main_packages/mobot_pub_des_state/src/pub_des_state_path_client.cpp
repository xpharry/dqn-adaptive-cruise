...
int main(int argc, char **argv) {
    ...
    // // point 1
    // pose.position.x = ra; // say desired x-coord is 5
    // pose.position.y = 0.0;
    // pose.position.z = 0.0; // let's hope so!
    ...
    // // point 2
    // pose.position.x = 3.0/2.0*ra; // say desired x-coord is 5
    // pose.position.y = sqrt(3.0)/2.0*ra;
    // pose.position.z = 0.0; // let's hope so!
    // quat = convertPlanarPhi2Quaternion(0);
    // pose.orientation = quat;
    // pose_stamped.pose = pose;
    ...
    // // point 5
    // pose.position.x = -1.0/2.0*ra; // say desired x-coord is 5
    // pose.position.y = sqrt(3.0)/2.0*ra;
    // pose.position.z = 0.0; // let's hope so!
    // quat = convertPlanarPhi2Quaternion(0);
    // pose.orientation = quat;
