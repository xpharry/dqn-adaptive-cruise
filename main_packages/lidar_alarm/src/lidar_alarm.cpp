...
int main(int argc, char **argv) {
	...
	ros::Publisher pub = nh.advertise<std_msgs::Bool>("catvehicle/lidar_alarm", 1);
	lidar_alarm_publisher_ = pub; // let's make this global, so callback can use it
	ros::Publisher pub2 = nh.advertise<std_msgs::Float32>("catvehicle/lidar_dist", 1);  
	lidar_dist_publisher_ = pub2;
	ros::Subscriber lidar_subscriber = nh.subscribe("catvehicle/front_laser_points", 1, laserCallback);
