...
class GazeboThreeLaneCircleTrackMultiVehicleLidarNnEnv(gazebo_env.GazeboEnv):

    def __init__(self):
        # Launch the simulation with the given launchfile name
        gazebo_env.GazeboEnv.__init__(self, "GazeboThreeLaneCircleTrackMultiVehicleLidar_v0.launch")
