...
class GazeboCircletrack3VehicleLccEnv(gazebo_env.GazeboEnv):

    def __init__(self):
        # Launch the simulation with the given launchfile name
        gazebo_env.GazeboEnv.__init__(self, "GazeboCircletrack3VehicleLcc_v0.launch")
    ...
    def construct_state(self):
        ...
        if self.base_path == None:
            return  [6.0] + cmp_dists + [self.speeds[0]] + cmp_speeds, False
    ...
    def _step(self, action):
        ...
        # change lane reward
        reward += self.change_lane_reward * 100
