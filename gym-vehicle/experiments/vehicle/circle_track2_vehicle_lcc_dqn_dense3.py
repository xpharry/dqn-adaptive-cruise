...
if __name__ == '__main__':
    ...
    outdir = '../../results/circle2_lcc_dense2/'
    ...
    weights_path = model_output + 'circle2_dense2_init.h5'
    monitor_path = model_output + 'circle2_dense2_init'
    params_json  = model_output + 'circle2_dense2_init.json'
