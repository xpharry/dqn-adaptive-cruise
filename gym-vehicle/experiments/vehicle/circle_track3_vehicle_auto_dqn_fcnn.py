...
if __name__ == '__main__':
    ...
    model_output = '~/saved_weights/circle3_auto/'
            ...
            if done:
                ...
                if not last100Filled:
                    ...
                    if epoch % 100 == 0:
                        ...
                        deepQ.saveModel(model_output+'circle3_fcnn_ep'+str(epoch)+'.h5')
                        # env.monitor.flush()
                        ...
                        with open(model_output+'circle3_fcnn_ep'+str(epoch)+'.json', 'w') as outfile:
