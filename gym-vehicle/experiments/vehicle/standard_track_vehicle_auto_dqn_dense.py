...
if __name__ == '__main__':
    ...
    env = gym.make('GazeboStandardtrackVehiceAuto-v0')
    ...
    model_output = '~/saved_weights/standard_auto/'
    weights_path = model_output + 'standard_fcnn_ep1000.h5'
    monitor_path = model_output + 'standard_fcnn_ep1000'
    params_json  = model_output + 'standard_fcnn_ep1000.json'
            ...
            if done:
                ...
                if not last100Filled:
                    ...
                    if epoch % 100 == 0:
                        ...
                        deepQ.saveModel(model_output+'standard_fcnn_ep'+str(epoch)+'.h5')
                        # env.monitor.flush()
                        ...
                        with open(model_output+'standard_fcnn_ep'+str(epoch)+'.json', 'w') as outfile:
