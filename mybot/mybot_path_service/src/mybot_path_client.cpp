...
#include <ros/ros.h>
#include <mybot_path_service/MyPathSrv.h> // this message type is defined in the current package
#include <iostream>
#include <string>
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "mybot_path_client");
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<mybot_path_service::MyPathSrv>("mybot_path_service");
    ...
    mybot_path_service::MyPathSrv path_srv;
