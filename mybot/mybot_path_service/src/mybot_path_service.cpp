...
#include <ros/ros.h>
#include <mybot_path_service/MyPathSrv.h>
...
bool callback(mybot_path_service::MyPathSrvRequest& request, mybot_path_service::MyPathSrvResponse& response) {
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "mybot_path_service");
    ros::NodeHandle n;
    ...
    ros::ServiceServer service = n.advertiseService("mybot_path_service", callback);
